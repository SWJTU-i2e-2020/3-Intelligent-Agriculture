...
BOM清单：
| 名称 | 数量 | 型号/规格 | 品牌 | 商品编号 | 封装 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| 电压比较器 | 1 | LM393 | IDCHIP(英锐芯) |  C400839 |  SOP-8 |
| 继电器 | 1 | LI05-1A85 |  STANDEXMEDER（斯丹麦德） | C575292 | DIP |
| 5v水泵 | 1 | - | - | - | - |
| LCD显示屏 | 1 | LCM1602K-FL-YBW | LONTECH(厦门龙特) | C83276 | Module |
| LED灯 | 2 | BTE3-117 | Bettertree(树上科技) | C454332 | - |
| 蜂鸣器 | 1 |  TMB12A12| 华能 | C96079 | Through Hole 7.62 |
| SX1278Lora模块 | 1 | Ra-02/0.91 | 安信可 | C90039 | Module |
| 排针 | 若干 | 2.54mm 1*20P直排针 | BOOMELE(博穆精密) | C50981 | 2.54mm |
| ESP32开发板 | 2 | NodeMCU-32SLua | 安信可 | C111436 | - |
| 温度传感器 | 1  | MCP9801-M/MS  |  MICROCHIP(美国微芯） |  C152175 | MSOP-8 |
...
当网关和节点同时工作时即可完成对温湿度的检测和浇水报警的操作。

因为模块运行在esp32上的缘故，首先在下载上开发板之前必须配置esp32的开发环境，这个可以直接在arduino管理库中下载，也可以直接在github上找到esp32,下载后arduino离线安装，搭建好之后直接使用arduino编译器将程序内容下载到开发板上，可以实现对温度的检测和浇水报警的操作。节点和网关分别通上电后便可使用。在网关处的液晶显示屏和蜂鸣器对温湿度进行实时反馈。
